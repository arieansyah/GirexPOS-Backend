...
<head>
    ...
    <title>Girex - POS</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/landing_page/favicon.ico') }}" />
    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="/"><span class="fw-bolder text-primary">Girex POS</span></a>
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div
                                ...
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                    href="https://wa.me/6282250314988">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small m-0">Copyright &copy; Girex POS 2024</div>
                </div>
                <div class="col-auto">
