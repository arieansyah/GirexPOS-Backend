<div class="btn-group btn-group-sm">
    @isset($edit)
        <button type="button" id="editButton" class="btn btn-warning" data-id="{{ $edit['id'] }}"
            data-name="{{ $edit['name'] }}" data-description="{{ $edit['description'] }}"
            data-value="{{ number_format($edit['value']) }}" data-status="{{ $edit['status'] }}"
            data-type="{{ $edit['type'] }}" data-expire_date="{{ $edit['expire_date'] }}">
