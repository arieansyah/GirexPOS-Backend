...
use App\Http\Requests\Backend\Users\RoleRequest;
...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.roles.create', compact('permissions', 'modules'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('role.index')->withSuccess(__('message.saved_successfully'));
    }
