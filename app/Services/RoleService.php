...
Class RoleService
{
     ...
     * @return void
     */
    public function getAllRolesReject(): array
    {
    ...
    {
        $allRoles = $this->role->select('name')->get();
        // ->whereNotIn('name', ['super-admin', 'admin', 'kasir'])
        // dd($allRoles);
     ...
     * @return void
     */
    public function getRoleHasPermission($id): array
    {
